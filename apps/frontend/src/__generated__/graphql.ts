...
export type GetEpisodesQuery = { __typename?: 'Query', getEpisodes: { __typename?: 'EpisodeConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, startCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean }, edges?: Array<{ __typename?: 'EpisodeEdge', node: { __typename?: 'Episode', id: string, title: string, url: string, createdAt: string, updatedAt: string, serial: { __typename?: 'Serial', id: string, title: string, imageUrl: string, description: string, rating: number } } }> | null } };
...
export type GetUserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, name: string, email: string, emailVerified: number, image: string } };
