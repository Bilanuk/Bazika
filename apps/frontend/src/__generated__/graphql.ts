...
export type GetSerialQuery = { __typename?: 'Query', serial: { __typename?: 'Serial', id: string, title: string, imageUrl: string, description: string, episodes: { __typename?: 'EpisodeConnection', edges?: Array<{ __typename?: 'EpisodeEdge', node: { __typename?: 'Episode', id: string, title: string, url: string, episodeNumber: number, createdAt: string, updatedAt: string } }> | null } } };
